...
var languageString = {
    "en": {
        "translation": {
            ...
            "GAME_NAME" : "Wine Trivia", // Be sure to change this for your skill.
            "HELP_MESSAGE": "I will ask you %s multiple choice questions. Respond with the number of the answer. " +
            "For example, say one, two, three, or four. To start a new game at any time, say, start game. See? " +
            "Easy enough for even a numbskull like you.",
            "REPEAT_QUESTION_MESSAGE": "To repeat the last question, say, repeat, and listen this time. ",
            "ASK_MESSAGE_START": "Would you like to start playing?",
            "HELP_REPROMPT": "How many times do we have to go over this? Answer with the number of the answer. ",
            "STOP_MESSAGE": "Would you like to keep playing?",
            "CANCEL_MESSAGE": "Ok, we\'ll cancel play. Loser!",
            "NO_MESSAGE": "Ok, we\'ll stop for now. Loser!",
            "TRIVIA_UNHANDLED": "Hey! Pay Attention. Say a number between 1 and %s",
            "HELP_UNHANDLED": "Say yes to continue, or no to end the game.",
            "START_UNHANDLED": "Say start to start a new game.",
            "NEW_GAME_MESSAGE": "Welcome to %s. ",
            "WELCOME_MESSAGE": "I will ask you %s questions, try to get as many right as you can. " +
            "Just say the number of the answer. Let\'s do this. ",
